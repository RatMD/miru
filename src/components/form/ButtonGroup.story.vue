<template>
    <Story title="Form/ButtonGroup" :layout="{ type: 'grid', width: '800px' }">
        ...
        <Variant title="Manually">
            <ButtonGroup manually align="center">
...
At the moment, only the default __ButtonStd__ component is 
supported.
</docs>
