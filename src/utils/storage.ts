...
export type MiruStorageCallback = (newValue: any, oldValue: any, key: string, storage: MiruStorage) => void;
...
class MiruStorage {
     ...
     */
    private listeners: { [key: string]: MiruStorageCallback[] };

    /**
     * Create a new MiruStorage class
     * @param prefix 
     * @param storageEngine 
     */
    ...
    public set(key: string, value: any): void {
        ...
        if (typeof this.listeners[key] !== 'undefined') {
            this.listeners[key].forEach((cb: MiruStorageCallback) => cb(value, oldValue, key, this));
        }
        if (typeof this.listeners['_all'] !== 'undefined') {
            this.listeners['_all'].forEach((cb: MiruStorageCallback) => cb(value, oldValue, key, this));
        }
    ...
    public remove(key: string): void {
        ...
        if (typeof this.listeners[key] !== 'undefined') {
            this.listeners[key].forEach((cb: MiruStorageCallback) => cb(null, oldValue, key, this));
        }
        if (typeof this.listeners['_all'] !== 'undefined') {
            this.listeners['_all'].forEach((cb: MiruStorageCallback) => cb(null, oldValue, key, this));
        }
     ...
     * @param callback 
     */
    public listen(callback: MiruStorageCallback) {
        if (typeof this.listeners['_all'] === 'undefined') {
            this.listeners['_all'] = [];
        }
     ...
     * @param callback 
     */
    public listenTo(key: string, callback: MiruStorageCallback) {
        if (typeof this.listeners[key] === 'undefined') {
            this.listeners[key] = [];
        }
